/**
 * @file stockUtils.ts
 * @description Utilidades de dominio para cálculo de estado de inventario/stock.
 ...
 * @returns 'out' si es 0, 'low' si es ≤ 10, 'ok' en caso contrario.
 * @example getStockStatus(0) // => 'out'
 */
