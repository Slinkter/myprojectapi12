...
const Cart = () => {
    ...
    return (
        <div className={`fixed top-0 right-0 h-full transform transition-transform duration-300 ease-in-out ${isCartOpen ? "translate-x-0" : "translate-x-full"} w-full max-w-md z-50`}>
            <div className="neumo-card h-full flex flex-col p-4">
                <div className="cart-drawer__header">
                    <h5 className="font-bold text-xl">
                        Shopping Cart
                    </h5>
                    <button onClick={closeCart} className="neumo-button rounded-full p-2 w-8 h-8 flex items-center justify-center">
