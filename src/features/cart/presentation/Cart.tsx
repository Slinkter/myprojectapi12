...
const Cart = () => {
    ...
    return (
        <>
            ...
            >
                <div className="cart-drawer h-full flex flex-col p-4 sm:p-6 bg-[var(--bg-card)]">
                    ...
                    {cart.length > 0 && (
                        <div className="cart-drawer__footer border-t border-gray-200 dark:border-gray-700 pt-4 mt-auto flex flex-col gap-3 sm:gap-4">
                            <div className="cart-drawer__total-row">
                                ...
                                <h6 className="font-bold text-base sm:text-lg text-amber-600 dark:text-amber-500">
                            ...
                            <div className="flex flex-col sm:flex-row w-full gap-2 sm:gap-3">
                                <button
                                    onClick={clearCart}
                                    className="cart-clear-button w-full sm:w-1/2 py-2.5 sm:py-3 bg-red-500 hover:bg-red-600 text-white text-sm sm:text-base"
                                ...
                                <button
                                    ...
                                    className="cart-checkout-button w-full sm:w-1/2 py-2.5 sm:py-3 text-sm sm:text-base"
