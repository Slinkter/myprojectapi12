...
// import React from "react"; // Removed: React is not explicitly used here

const Checkout = () => {
  // useCheckout hook is already typed, so these are correctly inferred
  const {
    paymentMethod,
    cardInfo,
    errors,
          ...
          <div className="flex items-center">
            ...
            <label
              ...
              className={`checkout-payment-method-button w-full text-center p-3 cursor-pointer focus-within:ring-2 focus-within:ring-amber-500 ${
                paymentMethod === "visa" ? "checkout-payment-method-button--pressed" : ""
              }`}
              role="button"
              tabIndex={0}
              onKeyDown={(e) => {
            ...
            <label
              ...
              className={`checkout-payment-method-button w-full text-center p-3 cursor-pointer focus-within:ring-2 focus-within:ring-amber-500 ${
                paymentMethod === "mastercard"
                  ? "checkout-payment-method-button--pressed"
                  : ""
              }`}
              role="button"
              tabIndex={0}
            ...
            <div className="relative">
              ...
              <i
                className={`absolute right-4 top-1/2 -translate-y-1/2 text-2xl ${
                  cardType === "visa" ? "fab fa-cc-visa" : cardType === "mastercard" ? "fab fa-cc-mastercard" : ""
                }`}
                aria-hidden="true"
              />
              {errors.number && (
